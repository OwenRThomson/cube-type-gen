...
/*
  This file is from the Cube-Ts project:
  https://github.com/benhall-7/cube-ts
*/
...
export type MemberType<Member> = Member extends MemberConfig<infer T, any>
  ? T
  : never;
export type MemberFilterType<Member> = Member extends MemberConfig<any, infer T>
  ? T
  : never;
