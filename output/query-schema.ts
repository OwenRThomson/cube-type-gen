...
const MeasureNameSchema = z.enum(["CubeName.count"]);
const DimensionNameSchema = z.enum(["CubeName.dimension"]);
const TimeDimensionNameSchema = z.never();
const SegmentNameSchema = z.never();
